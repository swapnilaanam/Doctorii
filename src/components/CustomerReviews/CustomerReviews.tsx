    ...
    <section className="bg-white">
      ...
      >
        <div className="w-full lg:w-2/5">
          <h2 className="text-3xl font-semibold sm:text-5xl capitalize text-sky-600">
        ...
        <div className="w-full lg:w-9/12 flex justify-center !overflow-hidden relative">
          <Swiper navigation={true} modules={[Navigation]} className="mySwiper !static mt-28">
            <SwiperSlide>
              <blockquote
                className="flex h-full flex-col justify-between bg-white p-12 border-2 border-sky-300 rounded-lg"
              >
                <div>
